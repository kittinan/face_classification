...
trained_models_path = '../trained_models/gender_models/gender_mobilenet_0.25'
...
model = MobileNet(input_shape=input_shape, include_top=True, alpha=0.25, classes=num_classes, weights=None)
